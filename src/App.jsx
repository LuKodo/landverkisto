    ...
    <>
      ...
      <div className="container w-full md:max-w-3xl mx-auto pt-20">
        <div className="w-full font-serif px-4 md:px-6 text-xl text-gray-800 leading-normal">
          <Router>
            <FrontPage path="/" />
            <FrontPage path="/frontpagxo" />
            <Dedicatoria path="/dedicxo" />
            <Kagxoj path="/kagxoj" />
            <KioNiEstas path="/kio-ni-estas" />
            <Cxenoj path="/cxenoj" />
            <Nokte path="/nokte" />
            <LaAtendo path="/la-atendo" />
            <Nuda path="/nuda" />
            <Revo path="/revo" />
            <SubViaOmbro path="/sub-via-ombro" />
            <EnLaFlavaUrbo path="/en-la-flava-urbo" />
          </Router>
        </div>
